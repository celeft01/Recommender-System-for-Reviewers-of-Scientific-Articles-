...
aname63=['Anna Philippou','David Walker']
allKeys=['confluence','determinacy','process calculus']
kNeigbors=100
bigCount=0
...
while(bigCount<3):
    ...
    distances, indices = model_knn.kneighbors(query_item, n_neighbors = kNeigbors)#out 10 for testing
    ...
    distances2, indices2 = model_knn2.kneighbors(query_item2, n_neighbors = kNeigbors)#out 10 for testing
